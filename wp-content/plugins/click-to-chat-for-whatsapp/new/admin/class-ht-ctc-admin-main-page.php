    ...
    function ctc_url_strucutre_cb() {
        ...
        <div class="row">
            ...
            <div class="input-field col s6">
                ...
                <p class="description" style="font-size: 11px;">
                    ...
                    <span style="font-weight: 500;">Web WhatsApp</span>: To open web.whatsapp.com<br>
        ...
        <div class="row">
            ...
            <div class="input-field col s6">
                ...
                <p class="description" style="font-size: 11px;">
                    <span style="font-weight: 500;">Wa.me</span>: Open WhatsApp Mobile app <br>
                    <span style="font-weight: 500;">WhatsApp://</span>: Open WhatsApp Mobile app directly<br>
                    <span style="font-weight: 500;">Custom URL</span>: Add any URL (PRO).
                </p>
            </div>
        </div>
    ...
    function options_cb() {
        if ( !defined('HT_CTC_PRO_VERSION') ) {
            ...
            <div style="margin-bottom: 25px;">
                ...
                <p class="description"><a target="_blank" href="https://holithemes.com/plugins/click-to-chat/business-hours-online-offline/">PRO</a></p>
            </div>
