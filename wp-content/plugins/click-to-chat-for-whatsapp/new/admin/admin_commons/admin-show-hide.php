...
<!-- <details style="margin-top:5px;">
    <summary style="cursor:pointer; list-style-type: disc;"><?php _e( 'Usecases', 'click-to-chat-for-whatsapp' ); ?></summary>
...
if ( !defined('HT_CTC_PRO_VERSION') && isset($type) && 'chat' == $type ) {
    ...
    <!-- todo make this look beeter -->
    <!-- <p class="description ht_ctc_subtitle">PRO</p> -->
    ...
    <div class="ctc_pro_content" style="margin-bottom: 25px;">
        ...
        <p class="description"><a target="_blank" href="https://holithemes.com/plugins/click-to-chat/time-delay-scroll/">PRO</a></p>
    </div>
